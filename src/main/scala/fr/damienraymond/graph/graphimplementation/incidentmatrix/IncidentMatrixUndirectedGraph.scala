...
//  */
//class IncidentMatrixUndirectedGraph(graph: IncMatGraph) extends IUndirectedGraph[Int] {
//
...
//
//  override val allNodes: Set[Int] = Set.empty
//
//}
//
...
//
//  def apply(graph: IUndirectedGraph[Int]): IncidentMatrixUndirectedGraph =
//    IncidentMatrixUndirectedGraph(
